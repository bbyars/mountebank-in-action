function (requestData, logger) {
    try {
        var path = require('path'),
            parserPath = path.join(process.cwd(), '/../RemotingProtocolParser/nodejs/lib/remotingProtocolParser'),
        ...
        // Assume the best...
        logger.error('End of request resolver failed; assuming request ended:');
        logger.error(e);
        return true;
    }
}